...
#define TARGET_BOARD_IDENTIFIER         "KoT_V1_0"
#define USBD_PRODUCT_STRING             "kot_V1_0"
...
#define PINIO1_PIN                  PB9  // camera
#define PINIO2_PIN                  PA14
#define PINIO3_PIN                  PC5
...
#define DEFAULT_FEATURES                (FEATURE_OSD | FEATURE_SOFTSERIAL | FEATURE_GPS | FEATURE_TELEMETRY | FEATURE_CURRENT_METER | FEATURE_VBAT | FEATURE_TX_PROF_SEL | FEATURE_BLACKBOX)
